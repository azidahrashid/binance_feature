              ...
              <span>
                <i className="fa-solid fa-xmark"></i>
					...
					<Alert  variant="success" dismissible show={state.solidsuccess} className="solid">						
						<strong>Success!</strong> Message has been sent. 
						<button className="btn-close" onClick={()=>dispatch({type:'solidsuccess'})}>
              <span>
                <i className="fa-solid fa-xmark"></i>
              </span>
            </button>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Alert  variant="secondary" dismissible show={state.dicsecondary}>
                {emojis.done}
                <strong>Done! </strong> Your profile photo updated. 
                <button className="btn-close" onClick={()=>dispatch({type:'dicsecondary'})}>
                  <span>
                    <i className="fa-solid fa-xmark"></i>
                  </span>
                </button>
        ...
        <Col xl={6}>
          <Card>
            ...
            <Card.Body>
              ...
              <Alert  variant="info" dismissible show={state.altinfo} className='alert-alt'>
                {emojis.info}
                <strong>Info!  </strong> You have got 5 new email. 
          ...
          <Card>
            ...
            <Card.Body>            
              ...
              <Alert  variant="secondary" dismissible show={state.soliddicsecondary} className="solid">						
                {emojis.done}
                <strong>Done! </strong> Your profile photo updated. 
                <button className="btn-close" onClick={()=>dispatch({type:'soliddicsecondary'})}>
                  <span>
                      <i className="fa-solid fa-xmark"></i>
                    </span>
                </button>
          ...
          <Card>
            ...
            <Card.Body>             
                ...
                <Alert  variant="info" dismissible show={state.outlineinfo} className="alert-outline-info">						
                   Info! {" "} You have got 5 new email. 
                  <button className="btn-close" onClick={()=>dispatch({type:'outlineinfo'})}><span><i className="fa-solid fa-xmark"></i></span></button>
                </Alert>
