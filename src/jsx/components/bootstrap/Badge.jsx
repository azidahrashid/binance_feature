      ...
      <Row>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
					<Badge as="a" bg="primary">Links</Badge>
					<Badge as="a" bg="secondary">Links</Badge>
					<Badge as="a" bg="success">Links</Badge>
					<Badge as="a" bg="danger">Links</Badge>
					<Badge as="a" bg="warning">Links</Badge>
					<Badge as="a" bg="info">Links</Badge>
					<Badge as="a" bg="light">Links</Badge>
					<Badge as="a" bg="dark">Links</Badge>
              </div>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                <Badge as="a" bg="primary badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="secondary badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="success badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="danger badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="warning badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="info badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="light badge-rounded">
                  Rounded
                </Badge>

                <Badge as="a" bg="dark badge-rounded">
                  Rounded
                </Badge>
              </div>
            </Card.Body>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                <Badge as="a" bg="badge-rounded" className='badge-outline-primary'>
                  Rounded
                </Badge>

                <Badge as="a" bg=" badge-rounded" className='badge-outline-secondary'>
                  Rounded
                </Badge>

                <Badge as="a" bg=" badge-rounded" className='badge-outline-success'>
                  Rounded
                </Badge>

                <Badge as="a" bg=" badge-rounded" className='badge-outline-danger'>
                  Rounded
                </Badge>

                <Badge as="a" bg=" badge-rounded" className='badge-outline-warning'>
                  Rounded
                </Badge>

                <Badge as="a" bg=" badge-rounded" className='badge-outline-info'>
                  Rounded
                </Badge>

                <Badge as="a" bg=" badge-rounded" className='badge-outline-light'>
                  Rounded
                </Badge>

                <Badge as="a" bg="badge-rounded" className='badge-outline-dark'>
                  Rounded
                </Badge>
              </div>
            </Card.Body>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                <Badge as="a" bg=" badge-circle" className='badge-outline-primary'>
                  1
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-secondary'>
                  2
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-success'>
                  3
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-danger'>
                  4
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-warning'>
                  5
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-info'>
                  6
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-light'>
                  7
                </Badge>

                <Badge as="a" bg=" badge-circle" className='badge-outline-dark'>
                  8
                </Badge>
              </div>
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                ...
                <Badge as="a" bg="secondary badge-circle">
                  2
                </Badge>

                <Badge as="a" bg="success badge-circle">
                  3
                </Badge>

                <Badge as="a" bg="danger badge-circle">
                  4
                </Badge>

                <Badge as="a" bg="warning badge-circle">
                  5
                </Badge>

                <Badge as="a" bg="info badge-circle">
                  6
                </Badge>

                <Badge as="a" bg="light badge-circle">
                  7
                </Badge>

                <Badge as="a" bg="dark badge-circle">
                  8
                </Badge>
              </div>
            </Card.Body>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                <Badge as="a" bg="" className='badge-outline-primary'>
                  1
                </Badge>

                <Badge as="a" bg="" className='badge-outline-secondary'>
                  2
                </Badge>

                <Badge as="a" bg="" className='badge-outline-success'>
                  3
                </Badge>

                <Badge as="a" bg="" className='badge-outline-danger'>
                  4
                </Badge>

                <Badge as="a" bg="" className='badge-outline-warning'>
                  5
                </Badge>

                <Badge as="a" bg="" className='badge-outline-info'>
                  6
                </Badge>

                <Badge as="a" bg="" className='badge-outline-light'>
                  7
                </Badge>

                <Badge as="a" bg="" className='badge-outline-dark'>
                  8
                </Badge>
              </div>
            </Card.Body>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                <Badge as="a" bg="primary badge-xs">
                  xs
                </Badge>

                <Badge as="a" bg="secondary badge-sm">
                  sm
                </Badge>

                <Badge as="a" bg="success badge-md">
                  md
                </Badge>

                <Badge as="a" bg="danger badge-lg">
                  lg
                </Badge>

                <Badge as="a" bg="warning badge-xl">
                  xl
                </Badge>
              </div>
            </Card.Body>
