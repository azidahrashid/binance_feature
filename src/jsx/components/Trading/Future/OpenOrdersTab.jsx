                    ...
                    <div className="th-dataTables th-dataTables_tr">
                        ...
                        <div className="tbody-dataTables">
                             ...
                             <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables"><div className="d-flex align-items-center justify-content-start "><span className=" TypeOrder_item text-TakepRofitMarket">Take Profit Market</span></div></div>
                                <div className="td-dataTables"><div className="d-flex align-items-center justify-content-start "><span className="text-black AmountOrder_item">5.5659 USDT</span></div></div>
                                <div className="td-dataTables"><div className="d-flex justify-content-start flex-column"><div className="TriggerConditions_item text-TriggerConditions">표시가</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronRight size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.9294</span></div></div></div>
                               
                                <div className="td-dataTables"><div className="d-flex justify-content-between gap-2 flex-row"><button type="button" className="btn btn-success btn-xs text-uppercase flex-grow-1">수정</button><button type="button" className="btn btn-danger  btn-xs text-uppercase flex-grow-1">취소</button></div></div>
                            </div>
                            <div className="tr-dataTables">
                                <div className="td-dataTables"><div className="d-flex align-items-center justify-content-start size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>     
                                <div className="td-dataTables"><div className="d-flex align-items-start justify-content-start symbol_item_wrap flex-column"><div className="symbol_item">XRPUSDT</div><div className="d-flex align-items-center"><span className="symbol_item"><span class="badge-dark light badge badge-xs badgexs_title mx-1 border-radius-5">Perp</span></span><span className="symbol_item"><span class="badge-dark light  badge badge-xs badgexs_title mx-1 border-radius-5">20x</span></span></div></div></div>
                                <div className="td-dataTables"><div className="d-flex align-items-center justify-content-start "><span className=" TypeOrder_item text-StopMarket">Stop Market</span></div></div>
                                <div className="td-dataTables"><div className="d-flex align-items-center justify-content-start "><span className="text-black AmountOrder_item">5.5659 USDT</span></div></div>
                                <div className="td-dataTables"><div className="d-flex justify-content-start flex-column"><div className="TriggerConditions_item text-TriggerConditions">표시가</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronLeft size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.3112 </span></div></div></div>
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-between gap-2 flex-row"><button type="button" className="btn btn-success btn-xs text-uppercase flex-grow-1">수정</button><button type="button" className="btn btn-danger  btn-xs text-uppercase flex-grow-1">취소</button></div></div>
                            </div>
