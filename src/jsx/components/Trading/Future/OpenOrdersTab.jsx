                    ...
                    <div className="th-dataTables th-dataTables_tr">
                        ...
                        <div className="tbody-dataTables">
                             ...
                             <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables"><div className="d-flex justify-content-center flex-fill flex-column"><div className="TriggerConditions_item text-TriggerConditions">표시가</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronRight size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.9294</span></div></div></div>
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black AmountOrder_item">5.5659 USDT</span></div></div>
                                <div className="td-dataTables"><div className="d-flex justify-content-center flex-fill flex-column"><div className="TriggerConditions_item text-TriggerConditions">표시가</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronLeft size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.3112 </span></div></div></div>
