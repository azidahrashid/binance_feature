            ...
            <div className="table-responsive dataTabletrade " >
                <div id="futureOpenorder_wrapper" className="dataTables_wrapper no-footer position_dataTables">
                    ...
                    <div className="th-dataTables th-dataTables_tr">
                                ...
                                <div className="th-dataTables" style={{width:'250px'}}><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center"></div></div></div>
                            </div>
                        </div>
