                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        ...
                        <div className="tbody-dataTables">
                             ...
                             <div className="tr-dataTables tdGreen">
                                 ...
                                 <div className="td-dataTables table-w-1"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-mark-price LiqPrice_item">1.2345</span></div></div>
