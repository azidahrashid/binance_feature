                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        <div className="thead-dataTables">
                             <div className="th-dataTables th-dataTables_tr">
                                 ...
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">진입가</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">현재가</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">청산가</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">마진율</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">증거금</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">미실현수익(수익률 %)</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-closePosition d-flex items-center justify-content-center w-full">포지션종료</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">TP/SL</div></div></div>
                            </div>
                        </div>
