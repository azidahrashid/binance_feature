                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        <div className="thead-dataTables">
                             <div className="th-dataTables">
                                 <div className="th-dataTables table-w-1"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText flex items-center justify-content-center w-full">코인종류</div></div></div>
                                 <div className="th-dataTables table-w-1"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText flex items-center justify-content-center w-full">사이즈</div></div></div>
