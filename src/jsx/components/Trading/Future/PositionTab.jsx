                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        ...
                        <div className="tbody-dataTables">
                              ...
                              <div className="tr-dataTables tdGreen">
                                 ...
                                 <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap"><span className="text-size-trade size_item">9.6603 USDT</span></div></div>
                             ...
                             <div className="tr-dataTables tdRed">
                                 ...
                                 <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap"><span className="text-size-trade-minus size_item"><Minus size={12} />9.7269 USDT</span></div></div>
                                 <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black EntryPrice_item">2.35326</span></div></div>
                                 <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black MarkPrice_item">2.35366</span></div></div>
                                 <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-mark-price LiqPrice_item">1.2345</span></div></div>
                                 <div className="td-dataTables table-w-1"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black MarginRatio_item">0.10%</span></div></div>
