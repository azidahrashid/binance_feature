                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        <div className="thead-dataTables">
                             <div className="th-dataTables">
                                 ...
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">현재가</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">청산가</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">마진율</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">증거금</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">미실현수익(수익률 %)</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-closePosition d-flex items-center justify-content-center w-full">포지션종료</div></div></div>
                                 <div className="th-dataTables"><div className="d-flex align-items-center "><div className=" typography-caption2 text-TertiaryText d-flex items-center justify-content-center w-full">TP/SL</div></div></div>
                            </div>
                        </div>
                        <div className="tbody-dataTables">
                       
                              <div className="tr-dataTables tdGreen">
                                 <div className="td-dataTables line_tag table-w-1"><div className="d-flex align-items-start justify-content-center flex-fill symbol_item_wrap flex-column"><div className="symbol_item">XRPUSDT</div><div className="d-flex align-items-center"><span className="symbol_item"><span class="badge-dark light badge badge-xs badgexs_title mx-1 border-radius-5">Perp</span></span><span className="symbol_item"><span class="badge-dark light  badge badge-xs badgexs_title mx-1 border-radius-5">20x</span></span></div></div></div>
