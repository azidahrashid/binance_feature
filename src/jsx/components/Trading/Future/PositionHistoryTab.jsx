                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        <div className="thead-dataTables">
                            <div className="th-dataTables th-dataTables_tr">
                                ...
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">매수시간</div></div></div>
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">매도시간</div></div></div>
                                ...
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">매수가</div></div></div>
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">매도가</div></div></div>
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">실현손익</div></div></div>
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">실현손익 %</div></div></div>
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">수수료</div></div></div>
                                <div className="th-dataTables"><div className="d-flex align-items-center justify-content-center flex-fill"><div className=" typography-caption2 text-TertiaryText flex items-center">보유금액</div></div></div>
                            </div>
                        </div>
                        <div className="tbody-dataTables">   
                             <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black">매도</span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Buy">매수</span></div></div>
                            ...
                            <div className="td-dataTables"><div className="d-flex align-items-start justify-content-center flex-fill symbol_item_wrap flex-column"><div className="symbol_item">XRPUSDT</div><div className="d-flex align-items-center"><span className="symbol_item"><span class="badge-dark light badge badge-xs badgexs_title mx-1 border-radius-5">Perp</span><span class="badge-dark light  badge badge-xs badgexs_title mx-1 border-radius-5">20x</span><span class="badge-green badge badge-xs badgexs_title mx-1 border-radius-5">Long</span></span><span className="symbol_item"></span></div></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black text-TypeOrder_item-TP">TP</span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Buy">매수</span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className="text-black Executed_item">10.3685 USDT</span></div></div>
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black">매도</span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Sell">매도</span></div></div>
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black text-TypeOrder_item-SL">SL</span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Sell">매도</span></div></div>
                                <div className="td-dataTables"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill "><span className="text-black Executed_item">0.0000 USDT</span></div></div>
