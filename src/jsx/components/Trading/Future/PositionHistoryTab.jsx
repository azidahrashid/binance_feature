                    ...
                    <div id="example" className="table display dataTable no-footer" style={{minWidth:"845px"}}>
                        ...
                        <div className="tbody-dataTables">   
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-2"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill xs-text-wrap"><span class="small text-muted xs-text-display">매도가</span><span className="text-black AmountOrder_item">10.37535 USDT</span></div></div>
                                ...
                                <div className="td-dataTables table-w-2"><div className="td-dataTables d-flex  justify-content-center flex-fill  gap-2 flex-row xs-text-wrap"><span class="small text-muted xs-text-display">수수료</span><span className="badge tp-badge-success badge-lg"><Plus size={12} />12.34%</span></div></div>
                            ...
                            <div className="tr-dataTables">
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-start justify-content-center flex-fill symbol_item_wrap flex-column xs-text-wrap"><span class="small text-muted xs-text-display">코인종류</span><div className="symbol_item">XRPUSDT</div></div></div>
                                <div className="td-dataTables table-w-2"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap xs-text-wrap"><span class="small text-muted xs-text-display">매수시간</span><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables table-w-2"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill size_item_wrap xs-text-wrap"><span class="small text-muted xs-text-display">매도시간</span><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                ...
                                <div className="td-dataTables table-w-2"><div className="td-dataTables d-flex  align-items-center justify-content-center flex-fill xs-text-wrap"><span class="small text-muted xs-text-display">매수/매도</span><span className="text-black AmountOrder_item">9.5713 USDT</span></div></div>
