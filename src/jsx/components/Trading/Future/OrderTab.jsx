                    ...
                    <div className="th-dataTables th-dataTables_tr">
                        ...
                        <div className="tbody-dataTables">
                             ...
                             <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap xs-text-wrap xs-text-wrap"><span class="small text-muted xs-text-display">시간</span><span class="small text-muted xs-text-display">시간</span><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">구분</span><span className=" TypeOrder_item text-black">시장가</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">매수/매도</span><span className=" TypeOrder_item text-Buy">매수</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">채결가</span><span className="text-black Executed_item">0.0000 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">수량</span><span className="text-black AmountOrder_item">9.5310 USDT</span></div></div>
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">구분</span><span className=" TypeOrder_item text-black text-TypeOrder_item-TP">TP</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">매수/매도</span><span className=" TypeOrder_item text-Buy">매수</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">채결가</span><span className="text-black Executed_item">10.3685 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">수량</span><span className="text-black AmountOrder_item">10.37535 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex justify-content-center flex-fill flex-row gap-1 xs-text-wrap"><span class="small text-muted xs-text-display">주문가격</span><div className="TriggerConditions_item text-TriggerConditions">Last Price</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronRight size={12} style={{marginRight:'-3px'}}/><Equal size={12} />3.0100</span></div></div></div>
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap xs-text-wrap"><span class="small text-muted xs-text-display">시간</span><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">구분</span><span className=" TypeOrder_item text-black">지정가</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">매수/매도</span><span className=" TypeOrder_item text-Sell">매도</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">채결가</span><span className="text-black Executed_item">9.5659 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">수량</span><span className="text-black AmountOrder_item">9.5713 USDT</span></div></div>
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap xs-text-wrap"><span class="small text-muted xs-text-display">시간</span><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">구분</span><span className=" TypeOrder_item text-black text-TypeOrder_item-SL">SL</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">매수/매도</span><span className=" TypeOrder_item text-Sell">매도</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">채결가</span><span className="text-black Executed_item">0.0000 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center xs-text-wrap"><span class="small text-muted xs-text-display">수량</span><span className="text-black AmountOrder_item">9.5659 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex justify-content-center flex-fill flex-row gap-1 xs-text-wrap"><span class="small text-muted xs-text-display">주문가격</span><div className="TriggerConditions_item text-TriggerConditions">Last Price</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronLeft size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.7300</span></div></div></div>
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-center gap-2 flex-row flex-fill xs-text-wrap"><span class="small text-muted xs-text-display">상태</span><span className="badge tp-badge-success badge-lg">채결 </span></div></div>
                            </div>
