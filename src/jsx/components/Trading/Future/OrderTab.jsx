                    ...
                    <div className="th-dataTables th-dataTables_tr">
                        ...
                        <div className="tbody-dataTables">
                            ...
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-between gap-2 flex-row"><span className="badge tp-badge-cancel badge-lg">취소</span></div></div>
                            </div>
                            <div className="tr-dataTables">
