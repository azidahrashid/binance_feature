                    ...
                    <div className="th-dataTables th-dataTables_tr">
                        ...
                        <div className="tbody-dataTables">
                             ...
                             <div className="tr-dataTables">
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill symbol_item_wrap flex-column"><div className="symbol_item">XRPUSDT</div><div className="d-flex align-items-center"><span className="symbol_item"><span class="badge-dark light badge badge-xs badgexs_title mx-1 border-radius-5">Perp</span></span><span className="symbol_item"><span class="badge-dark light  badge badge-xs badgexs_title mx-1 border-radius-5"></span></span></div></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black">시장가</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Buy">매수</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black Executed_item">0.0000 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black AmountOrder_item">9.5310 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex justify-content-center flex-fill flex-row gap-1"><div className="TriggerConditions_item text-TriggerConditions">Last Price</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronRight size={12} style={{marginRight:'-3px'}}/><Equal size={12} />3.0100</span></div></div></div>
                               
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-center gap-2 flex-row flex-fill"><span className="badge tp-badge-success badge-lg">채결</span></div></div>
                            </div>
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black text-TypeOrder_item-TP">TP</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Buy">매수</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black Executed_item">10.3685 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black AmountOrder_item">10.37535 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex justify-content-center flex-fill flex-row gap-1"><div className="TriggerConditions_item text-TriggerConditions">Last Price</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronRight size={12} style={{marginRight:'-3px'}}/><Equal size={12} />3.0100</span></div></div></div>
                               
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-center gap-2 flex-row flex-fill"><span className="badge tp-badge-cancel badge-lg">취소</span></div></div>
                            </div>
                            <div className="tr-dataTables">
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill symbol_item_wrap flex-column"><div className="symbol_item">XRPUSDT</div><div className="d-flex align-items-center"><span className="symbol_item"><span class="badge-dark light badge badge-xs badgexs_title mx-1 border-radius-5">Perp</span></span><span className="symbol_item"><span class="badge-dark light  badge badge-xs badgexs_title mx-1 border-radius-5">20x</span></span></div></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black">지정가</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Sell">매도</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black Executed_item">9.5659 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black AmountOrder_item">9.5713 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex justify-content-center flex-fill flex-row gap-1"><div className="TriggerConditions_item text-TriggerConditions">Last Price</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronLeft size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.7300</span></div></div></div>
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-center gap-2 flex-row flex-fill"><span className="badge tp-badge-success badge-lg">채결</span></div></div>
                            </div>
                            <div className="tr-dataTables">
                                ...
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill size_item_wrap"><span className="DateTimeWrap size_item"> <span className="dataDate">2025-01-14 </span><span className="dataTime">15:23:21</span></span></div></div>      
                                <div className="td-dataTables table-w-2"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-black text-TypeOrder_item-SL">SL</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className=" TypeOrder_item text-Sell">매도</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black Executed_item">0.0000 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex align-items-center justify-content-center flex-fill "><span className="text-black AmountOrder_item">9.5659 USDT</span></div></div>
                                <div className="td-dataTables table-w-3"><div className="d-flex justify-content-center flex-fill flex-row gap-1"><div className="TriggerConditions_item text-TriggerConditions">Last Price</div><div className="d-flex"><span className="TriggerConditions_item text-TriggerConditions"> <ChevronLeft size={12} style={{marginRight:'-3px'}}/><Equal size={12} />2.7300</span></div></div></div>
                                <div className="td-dataTables" style={{width:'250px'}}><div className="d-flex justify-content-center gap-2 flex-row flex-fill"><span className="badge tp-badge-success badge-lg">채결 </span></div></div>
                            </div>
