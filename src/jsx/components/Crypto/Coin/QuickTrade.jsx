                    ...
                    <div className="basic-form">
                        <form className="form-wrapper trade-form">
                            <div className="input-group mb-3 ">
                                ...
                                <input className="form-control form-control text-end" type="number" placeholder="0,000000" />
                            </div>	
                            <div className="input-group mb-3 ">
                ...
                <div className="card-footer border-0">
                    ...
                    <div className="d-flex mt-3 align-items-center">
                        <div className="form-check custom-checkbox me-3">
                            ...
                            <label className="form-check-label fs-14 font-w400 mt-0" htmlFor="customCheckBox1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut</label>
                        </div>
                        <p className="mb-0"></p>
                    </div>
                </div>
