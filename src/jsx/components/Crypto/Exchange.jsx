                                            ...
                                            <tbody>
                                                {tableData.map((data, ind)=>(                                                    
                                                    <tr key={ind}>
                                                        ...
                                                        <td className="fs-14 font-w400">Jan 12,  2024</td>
                                                        <td>
                                                            <div className="d-flex align-items-center">
                                                                <Link to={"/email-inbox"}>
                                ...
                                <div className="card-body pt-2">
                                    ...
                                    <form>
                                        ...
                                        <div className="input-group mb-3">
                                            ...
                                            <input type="text" className="form-control" />
                                            <Dropdown>
                                                <Dropdown.Toggle  className="btn btn-primary btn-outline-primary left-radius pb-3">USDT</Dropdown.Toggle>
                                        ...
                                        <div className="mb-3 mt-4">
                                            ...
                                            <div className="input-group mb-3">
                                                ...
                                                <Dropdown>
                                                    <Dropdown.Toggle  className="btn-outline-primary left-radius pb-3">Mark</Dropdown.Toggle>
                                                    <Dropdown.Menu align="end"> 
                                        ...
                                        <div className="input-group mb-3">
                                            ...
                                            <input type="text" className="form-control" />                                            
                                            <Dropdown>
                                                <Dropdown.Toggle as="div"  className="btn btn-primary btn-outline-primary left-radius pb-3">Mark</Dropdown.Toggle>
                                                <Dropdown.Menu align="end"> 
